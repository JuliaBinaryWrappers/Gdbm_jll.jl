...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Gdbm_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("54ca2031-c8dd-5cab-9ed4-295edde1660f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Gdbm", artifacts_toml) for e in artifacts["Gdbm"]]
...
if best_platform === nothing
    @debug("Unable to load Gdbm; unsupported platform $(triplet(platform_key_abi()))")
else
