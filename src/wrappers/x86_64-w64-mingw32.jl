...
const gdbm_dump_splitpath = ["bin", "gdbm_dump.exe"]
...
const gdbm_load_splitpath = ["bin", "gdbm_load.exe"]
...
const gdbmtool_splitpath = ["bin", "gdbmtool.exe"]
...
const libgdbm_splitpath = ["bin", "libgdbm-6.dll"]
